            ...
            {!isEnumOption && (
                <>
                    ...
                    <FormControl>
                        <Select
                            value={param.type}
                            onChange={(e) => sreBuilderStore.setParameterType(indexArray, e.target.value as UIParameterNode['type'])}
                        >
                    ...
                    <FormControl>
                        <Checkbox
                            ...
                            onChange={(e) => sreBuilderStore.setParameterRequired(indexArray, e.target.checked)}
                        >
                            Required
                        </Checkbox>
                    </FormControl>
                    ...
                    {isPrimitive && (
                        <FormControl>
                            ...
                            <DefaultValueInput
                                param={param}
                                onChange={(value) => sreBuilderStore.setParameterDefaultValue(indexArray, value)}
                            />
                        </FormControl>
                    )}
